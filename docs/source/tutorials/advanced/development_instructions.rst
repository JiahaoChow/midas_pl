...
MIDAS is designed to integrate RNA, ADT, and ATAC data. If you'd like to develop the model, follow the instructions below.
...
Extend MIDAS to More Modalities
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Step 1: Define New Modality
----------------------------
...
Step 2: (Optional) Register New Functions
------------------------------
